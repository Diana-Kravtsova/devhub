...
export const Route = createFileRoute('/users/$id')({
  ...
  loader: ({context, params}) =>
    context.queryClient.ensureQueryData(userQueries.detail(params.id)),
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            />
            <div
              className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-gray-900 border-2 border-gray-800 flex items-center justify-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <Badge className={`${roleColors[user.role]} border capitalize px-3 py-1`}>
                {user.role}
              </Badge>
            </div>
          </div>
